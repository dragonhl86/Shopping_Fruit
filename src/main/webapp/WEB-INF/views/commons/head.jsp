...
<head>
    ...
    <!-- Bootstrap 3.3.6 -->
    <link rel="stylesheet" href='<%=request.getContextPath()%>/css/bootstrap-3.1.1.min.css'>
    <!-- Font Awesome -->
    ...
    <link rel="Fruitmark" href='<%=request.getContextPath()%>/img/favicon.ico'>




<%--    <link rel="stylesheet" href='<%=request.getContextPath()%>/css1/gallery.css'>--%>
